    ...
    @section('hero')
        <div class="w-full text-center py-32">
            <h1 class="text-2xl md:text-3xl font-bold text-center lg:text-5xl text-gray-700">
                Learn ecosystem <span class="text-yellow-500">laravel</span> <span class="text-gray-900"></span>
            </h1>
            <p class="text-gray-500 text-lg mt-1">with different packages and modules (Jetstream, Livewire and Filament)</p>
